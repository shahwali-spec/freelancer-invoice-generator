...
import type { Freelancer } from "@/types/invoice";
import { X } from "lucide-react";

export default function FreelancerInfoForm() {
    const { invoice, setInvoice } = useInvoice();
    const [preview, setPreview] = useState<string | null>(
        invoice.freelancer?.logoUrl ?? null
    );
    const [isDragging, setIsDragging] = useState(false);

    const handleChange =
        (key: keyof Freelancer) =>
            (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
                setInvoice({
                    freelancer: { ...(invoice.freelancer ?? {}), [key]: e.target.value },
                });
            };
    ...
    const handleLogoChange = (file: File) => {
        ...
        reader.onloadend = () => {
            ...
            setPreview(base64);
            setInvoice({
                freelancer: { ...(invoice.freelancer ?? {}), logoUrl: base64 },
            });
        };
    ...
    const handleRemoveLogo = () => {
        setPreview(null);
        setInvoice({
            freelancer: { ...(invoice.freelancer ?? {}), logoUrl: null },
        });
    };
            ...
            <CardContent className="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <Input
                        ...
                        value={invoice.freelancer?.email ?? ""}
                ...
                <div>
                    ...
                    <Input
                        ...
                        value={invoice.freelancer?.phone ?? ""}
                ...
                <div>
                    <Label>Website</Label>
                    <Input
                        placeholder="Portfolio or Business website"
                        value={invoice.freelancer?.website ?? ""}
                ...
                <div>
                    ...
                    <Input
                        ...
                        value={invoice.freelancer?.taxId ?? ""}
                ...
                <div className="md:col-span-2">
                    ...
                    <Textarea
                        ...
                        value={invoice.freelancer?.address ?? ""}
                ...
                <div className="md:col-span-2">
                    ...
                    <div
                        ...
                        onClick={() =>
                            document.getElementById("freelancerLogoInput")?.click()
                        }
                    >
